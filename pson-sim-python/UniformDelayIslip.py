...
for j in range(0,len(test_iter_list)):  
    for i in range(0,len(test_load_list)):
        ...
        filename="d:/2017/rhapsody/PSONSchedulerIslip/component_4/DefaultConfig/sim_result_D100000_S"
        ...
        #temp_average_delay.append(sample_mean)
        temp_average_hi_95.append(sample_hi_95)
        temp_average_lo_95.append(sample_lo_95)
    ...
    if j==0:
        ...
        average_hi_95.append(temp_average_hi_95)
        average_lo_95.append(temp_average_lo_95)
    ...
    #for i in range(0,5):
    plt.plot(test_load_list,average_delay[j][:])
...
for i in range(0,len(test_iter_list)):
    plt.plot(test_load_list, gapa_average_delay[i][:])
...
for i in range(0,len(test_iter_list)):
    plt.plot(test_load_list, percentile_delay_90[i][:])
    plt.plot(test_load_list, ga_percentile_delay_90[i][:])
    plt.plot(test_load_list, gapa_percentile_delay_90[i][:])
...
plt.plot(test_load_list, gapa_percentile_delay_99[1][:],label='1 iter-GPA')
...
plt.plot(test_load_list, gapa_percentile_delay_99[2][:],label='2 iter-GPA')
...
plt.plot(test_load_list, gapa_percentile_delay_99[3][:],label='3 iter-GPA')
...
plt.plot(test_load_list, gapa_percentile_delay_99[4][:],label='4 iter-GPA')
plt.title('99% delay - iteration:'+str(i))
plt.xlabel('Load')
plt.ylabel('Delay (time slots)')
