...
def make_filename2(duration, switch_size, load, iteration, Tth, Qth, hotspot, ganumber, scale):
...
for j in range(0,len(test_scale_list)):  
    for i in range(0,Switch_size):
        ...
        filename = make_filename(Duration, Switch_size, TrafficLoad, 5, Delay_threshold, Que_threshold, i, 4, test_scale_list[j])
        DATA = FILE_TO_ARRAY(filename)    
    ...
    plt.plot(hs_load_list,crrp_thruput,'bv--')
    #plt.plot(hs_load_list,cldf_thruput_hs)
    plt.title('Throughput - switch:'+str(Switch_size)+' scale:'+str(test_scale_list[j]), fontsize=14)
    plt.xlabel('Hot Spot Load (%)', fontsize=14)
    plt.ylabel('Throughput (%)', fontsize=14,)
    plt.ylim(80,105)
    plt.xlim(0,100)
    plt.legend(('Hotspot','Overall'))
    plt.show() 
...
for i in range(0,len(test_scale_list)):
    fig = matplotlib.pyplot.gcf()
    fig.set_size_inches(4.5, 3.5)
    matplotlib.rc('legend', fontsize=14, labelspacing=0.2, handlelength=2, frameon=False, loc='lower right')

    #plt.plot(hs_load_list, d_ga_thruput_hs[i][:],'bv--')
    #plt.plot(hs_load_list, d_gapa_thruput_hs[i][:])
...
for i in range(0,len(test_scale_list)):
    ...
    #plt.plot(hs_load_list, d_gapa_thruput[i][:])
...
plt.plot(hs_load_list, d_crrp_thruput_hs[3][:],'ro-')
plt.plot(hs_load_list, d_crrp_thruput_hs[4][:],'go-')
#plt.plot(hs_load_list, d_crrp_thruput[3][:],'ro-')
#plt.plot(hs_load_list, d_crrp_thruput_hs[1][:],'go-')
#plt.plot(hs_load_list, d_crrp_thruput_hs[2][:],'bo-')

plt.title('Hotspot throughput - switch:'+str(Switch_size),fontsize=14)
plt.xlabel('Hot Spot Load (%)',fontsize=14)
plt.ylabel('Throughput (%)',fontsize=14)
plt.legend(('C-RRP s=1', 'C-RRP s=2', 'C-RRP s=5', 'C-RRP s=10', 'C-RRP s=20'),loc='lower right',fontsize=14)
plt.ylim(90,102)
plt.show()
...
plt.plot(hs_load_list, d_crrp_thruput[3][:],'ro-')
plt.plot(hs_load_list, d_crrp_thruput[4][:],'go-')
#plt.plot(hs_load_list, d_crrp_thruput[1][:],'go-')
#plt.plot(hs_load_list, d_crrp_thruput[2][:],'bo-')
    
plt.title('Overall throughput - switch:'+str(Switch_size),fontsize=14)
plt.xlabel('Hot Spot Load (%)',fontsize=14)
plt.ylabel('Throughput (%)',fontsize=14)
plt.legend(('C-RRP s=1', 'C-RRP s=2', 'C-RRP s=5', 'C-RRP s=10', 'C-RRP s=20'),loc='lower right',fontsize=14)
plt.ylim(90,102)
